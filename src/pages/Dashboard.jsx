...
export default function Dashboard() {
  ...
  return <div className="page-wrap">
    ...
    <section className="mt-10"><div className="flex items-end justify-between gap-4"><div><p className="eyebrow">Your matched roles</p><h2 className="mt-2 font-display text-3xl font-bold text-night">Top roles</h2></div><Link to="/opportunities" className="hidden items-center gap-1 text-sm font-semibold text-night hover:text-crimson sm:flex">See all <ArrowRight size={15} /></Link></div>
      {loading
